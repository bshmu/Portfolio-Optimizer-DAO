mod optimizer_utils {
    ...
    use orion::numbers::fixed_point::implementations::impl_8x23::{
        FP8x23Add, FP8x23Div, FP8x23Mul, FP8x23Sub, FP8x23Impl
    };
    ...
    fn exponential_weights(lambda_unscaled: u128, l: u32) -> Tensor<FixedType> {
        ...
        let mut lambda = FixedTrait::new_unscaled(lambda_unscaled, false)
        ...
        loop {
            ...
            let i_u128: u128 = i.into();
            let mut i_fp = FixedTrait::new_unscaled(i_u128, false);
        ...
        let mut weights_tensor = TensorTrait::<FixedType>::new(
            weights_len.span(), weights_array.span(), Option::<ExtraParams>::None(())
        );
    ...
    fn weighted_covariance(X: Tensor<FixedType>, weights: Tensor<FixedType>) -> Tensor<FixedType> {
        ...
        let mean_weighted = TensorTrait::<FixedType>::new(
            mean_weighted_shape, mean_weighted_data.span(), Option::<ExtraParams>::None(())
        );
        ...
        let X_centered = TensorTrait::<FixedType>::new(
            X_centered_shape, X_centered_data.span(), Option::<ExtraParams>::None(())
        );
        ...
        let mut Cov_X_den = *weights.reduce_sum(0, false).data.at(0)
        ...
        let Cov_X = TensorTrait::<FixedType>::new(
            Cov_X_shape, Cov_X_data.span(), Option::<ExtraParams>::None(())
        );
